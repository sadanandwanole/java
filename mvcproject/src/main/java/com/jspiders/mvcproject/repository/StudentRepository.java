...
//			
//		}
//		jpql="from StudentPOJO Where id='"+id+"'";
//		query=manager.createQuery(jpql);
//		List <StudentPOJO>resultList = query.getResultList();
//		
		transaction.commit();
	...
	public StudentPOJO updateData1(int id, String name, String email, long contact, String city, String username,
		...
		openConnection();
		transaction.begin();
//		jpql="update from StudentPOJO set name= '"+ name +"' ,"+" email= '"+ email+ "' ," +" contact= '"+ contact +"' ,"
//				+" city= '"+ city +"' ,"+" username= '"+ username +"' ,"+" password= '" +password+"'"+" where id= '"+id+ "'";
//		query=manager.createQuery(jpql);
