...
<body>
	<div id=parent1>
		<div id="parent">
			...
			<div id="update">
				<a href="http://localhost:8080/EmployeeLogIn/Update.jsp"> <input
					type="button" value="Update" name="update" id="up">
				</a>
			</div>
			<div id="remove">
	...
	<form action="./SearchOperation.jsp" method="post">
		...
		<table>
			...
			<div>
				...
				<tr>
					<td></td>
					<td><input type="button" value="Serch Detail" id="sub">
					</td>
				</tr>
		</table>
...
caption {
	margin-left: 200px;
	background-color: rgb(220,90,200);
	width: 450px;
